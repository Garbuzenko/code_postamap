...
<a style="padding: .290rem .75rem;" class="btn btn-primary buttons-copy buttons-html5" tabindex="0" aria-controls="datatable-buttons" href="<?=DOMAIN;?>/admin/files/csv/mos_realty.csv"><span>Скачать CSV</span></a>
</div>
</div>
