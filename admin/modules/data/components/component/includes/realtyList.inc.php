...
<a style="padding: .290rem .75rem;" class="btn btn-primary buttons-copy buttons-html5" tabindex="0" aria-controls="datatable-buttons" href="<?=DOMAIN;?>/files/opendata/mos_realty.csv.zip"><span>Скачать CSV</span></a>
</div>
</div>
...
<form method="post" action="" id="form_jsHousesSearch">
  ...
  <div class="col-sm-12 col-md-8">
    ...
    <input type="text" id="houseAddress" name="address" value="<?=$address;?>" class="form-control jsClear jsClearInput jsSelectList" placeholder="Поиск по адресу" aria-controls="datatable-buttons"></label>
    
    <input type="hidden" id="houseAddress_mod" value="data" />
    <input type="hidden" id="houseAddress_com" value="component" />
    <input type="hidden" id="houseAddress_arr" value="mos_realty" />
    <input type="hidden" name="house_id" id="houseAddress_id" class="jsClear" value="<?=$house_id;?>" />
     
    <div id="houseAddress2" class="tmpAjaxListDiv hidden" style="width: 480px; margin-top: 2px;"></div>

  </div>
  
  <div class="col-sm-12 col-md-4">
    <label style="width: 100%;"><input type="text" id="districtFilter" name="district" value="<?=$district;?>" class="form-control jsClear jsClearInput jsSelectList" placeholder="Поиск по району" aria-controls="datatable-buttons"></label>
    ...
    <div id="districtFilter2" class="tmpAjaxListDiv hidden" style="width: 230px; margin-top: 2px;"></div>
